...
vShortCircuit = np.array([0.222,0.902,1.024,0.857,0.796,0.944,0.963,0.914,0.818,0.949,1.030,1.125,0.537,0.707,0.996,0.989,0.967,0.933,0.895,0.834,0.832,0.664,0.935,1.097,1.042,0.244])
vInductive = np.array([1.070,1.067,0.963,0.848,0.653,0.650,0.586,0.057,0.309,0.456,0.623,0.808,0.983,1.106,1.067,0.984,0.781,0.682,0.632,0.493,0.338,0.345,0.302,0.639,0.907,1.125])
vCapacitive = np.array([0.478,1.156,0.848,0.496,0.355,0.567,0.723,0.743,0.744,0.812,0.939,0.992,1.070,0.850,0.960,0.651,0.612,0.599,0.574,0.721,0.175,0.722,0.696,0.936,1.117,1.198])
vMatched = np.array([1.023,1.047,0.909,0.705,0.684,0.653,0.701,0.690,0.690,0.701,0.814,0.840,0.931,1.042,1.009,0.744,0.713,0.760,0.716,0.720,0.697,0.651,0.768,0.827,0.994,1.144])
...
for i in range(len(readingsFit)):
    ...
    graphs.setGrid("Distance /cm","Voltage /V")
